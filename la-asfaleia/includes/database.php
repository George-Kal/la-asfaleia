...
define("DB_NAME", "labros_asfaleia"); //το όνομα της βάσης δεδομένων

define("APPLICATION_VERSION", "1.0 beta"); //Η τρέχουσα έκδοση της διανομής
define("APPLICATION_NAME", "La-asfaleia"); //Η ονομασία της διανομής
define("APPLICATION_FOLDER", "http://".$_SERVER["HTTP_HOST"]."/"."la-asfaleia/"); //Ο φάκελος της διανομής
define("APPLICATION_ADMIN", "admin"); //Το όνομα χρήστη του διαχειριστή
define("APPLICATION_ADMIN_ID", 1); //Το id του πίνακα users για το διαχειριστή (ως επιπλέον δικλείδα ασφαλείας)
